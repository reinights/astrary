...
export default function NightSky({
  ...
  function convertStarsToGeometryData(
    ...
    for (let i = 0; i < total; i++) {
      ...
      const latRad = (lat * Math.PI) / 180; //everything within the calculation is in radians. This was the reason why the gpt code did not work ;(
      const sinAlt =
  ...
  //what actually creates the stars.
  ...
  /*---------------------------------    Moon Mapping with the same logic    -------------------------------------*/
